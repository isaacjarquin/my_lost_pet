...
if (process.env.WEBPACK_BUILD) {
    require('./newPetFoundMobile.scss')
}
...
class NewPetFoundMobile extends React.Component {
    constructor(props) {
        super(props)
            ...
            <div className='missing-pet-form-mobile'>
                ...
                <header id='new-pet' className='collapse w3-container w3-center w3-padding w3-light-grey'>
                    ...
                    <form onSubmit={this.handleSubmit}>
                        ...
                        <select className={`form-control landing-select-filter-mobile ${this.props.inputColor.petType}`} onChange={this.handlePetType}>
                                    ...
                                    <div className='drop-zone'>
                                        <div className='images-drop'>
                                            <Dropzone
                                                ...
                                                <p>Haz click sobre el area rectangular para seleccionar una imagen. La imagen tiene que ser siempre inferior a 2 Mbytes</p>
                                            </Dropzone>
                                        </div>
...
module.exports = NewPetFoundMobile

    ...
    return (
      <div>
        ...
        <div className='w3-margin'>
          ...
          <p>Como parte del proceso de registro de un animal, se pide un email y opcionalmente un numero de telefono. En ningun case este se utilizara para enviar publicidad ni se mostrara a terceros. La web le enviará un correo con los datos personales del dueno de la mascota y sera usted el que decidita como, cuando y si quier ponerse en contacto con la misma.</p>
        ...
        <div className='w3-margin'>
          ...
          <p>Al enviar, publicar o mostrar cualquier material en y a través del sitio, automáticamente el usuario nos otorga y autoriza una licencia mundial (permiso) para utilizar de manera gratuita, libre de regalías, con derecho de exhibir públicamente o redistribuir estos materiales en cualquier formato que el equipo de MyLostPet considere pertinente y a perpetuidad.</p>
          <p>Con excepción de lo expresamente autorizado por MyLostPet, no puedes copiar, modificar, publicar, transmitir, distribuir, ejecutar, exhibir o vender cualquier información y/o material (incluyendo en forma enunciativa pero no limitativa, imágenes, ilustraciones, textos, audios y cualquier otro material visual en lo sucesivo y en conjunto o separadamente “el material”) en MyLostPet. En este sitio encontraras marcas registradas y derechos de autor de las que todos los derechos están reservados. Todos los materiales contenidos en este sitio, están protegidos por derechos de autor y/o como marca registrada, por lo que no podrán ser usados para propositos distintos al de uso personal. La reproducción, copia, distribución, trabajos derivados, publicación y cualquier otra forma de copiado o de uso no autorizada del material aquí contenido está expresamente prohibida. Si deseas solicitar una licencia para usar algún material de este sitio, por favor escríbenos a mylostpet@gmail.com</p>
        </div>

        <div className='w3-margin'>
          <h6><b>Política de privacidad</b></h6>
          <p>La recopilación y uso de información personal se rige por nuestro Aviso de Privacidad. Haga clic aquí para revisar el Aviso de Privacidad MyLostPet. Entiendes y aceptas que MyLostPet puede acceder, conservar y revelar su información y el contenido que se suba a la web si así lo requiere la ley o si de buena fe considera que dicha reserva o revelación es razonablemente necesaria para cumplir con los requisitos legales, procesar o para proteger los derechos y la propiedad de MyLostPet, sus afiliados o el público.</p>

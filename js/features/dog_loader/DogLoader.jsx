      ...
      <div className='dog-loader'>
        <div className='loader-container'>
          ...
          <svg id='scottie-loader' className='loader-dog' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 207.95 211.52'>
            ...
            <path className='left-ear' d='M88.42 75.73C77.16 62.28 62.48 44.71 45 45.62c-1.61 15.74 8.82 41.9 24.73 48.73a44.07 44.07 0 0 1 18.69-18.62z' fill='#010101' fill-rule='evenodd' />
            ...
            <path className='right-ear' d='M69.42 78.07c-15.3-4.38-38.75-1.12-49.71 17.38 11.82 10.64 39.18 17.46 54 8.63a43.93 43.93 0 0 1-4.29-26.01z' fill='#010101' fill-rule='evenodd' />
        ...
        <div className='progress-bar_percentage displayNone'>{this.props.percentage}%</div>
      </div>
    )
  }
}
